...
class Expense {
        ...
        renderExpenseRow() { 
                ...
                // let expenseRowToRender = `<div class="user-input-expenses">
                //                                 <div class="expense">   
                ...
                //                                 </div> 
                //                           </div>`
                // expenseInputContainer.innerHTML = expenseRowToRender;    

                // let expenseInput = document.querySelector(".expense-input")
                // let expenseAmountInput = document.querySelector(".expense-amount-input")
                // let paidCheckBox = document.querySelector(".checked")
                ...
                //         this.amount = expenseAmountInput.value;
                //         this.saveExpenseRowToDatabase();
                // })
                // paidCheckBox.addEventListener("change", () => {
                //         this.isChecked = paidCheckBox.checked;
                //         this.saveExpenseRowToDatabase();
                // })
...
//         Expense.loadExpenseRowFromDatabase();
        
//         // renders the initial row upon first page visit if no prior data is saved
